                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <div class="col-sm-6 col-md-5 col-xl-3 mg-t-20 mg-xl-t-0">
                            <a class="btn btn-primary" href="{{ route('admin.reports.create') }}"> Add-Report+ </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example1" class="table table-striped table-bordered table-hover text-md-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">UserID</th>
                                    ...
                                    @foreach ($reports as $report)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.reports.edit', $report->id) }}" class="btn btn-sm btn-info d-inline mr-1">Edit</a>
                                                <a href="{{ route('admin.reports.delete', $report->id) }}" class="btn btn-sm btn-danger d-inline">Delete</a>
                                            </td>
