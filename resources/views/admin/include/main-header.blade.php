    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            {{-- <div class="responsive-logo">
                <a href="{{ url('/' . ($page = 'index')) }}"><img src="{{ asset('admin/assets/img/brand/logo.png') }}"
                        class="logo-1" alt="logo"></a>
                <a href="{{ url('/' . ($page = 'index')) }}"><img src="{{ asset('admin/assets/img/brand/logo-white.png') }}"
                        class="dark-logo-1" alt="logo"></a>
                <a href="{{ url('/' . ($page = 'index')) }}"><img src="{{ asset('admin/assets/img/brand/favicon.png') }}"
                        ...
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            <a href="#" class="dropdown-item d-flex ">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><img
                                        src="{{ asset('admin/assets/img/flags/french_flag.jpg') }}"
                                        alt="img"></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><img
                                        src="{{ asset('admin/assets/img/flags/germany_flag.jpg') }}"
                                        alt="img"></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar ml-3 align-self-center bg-transparent"><img
                                        src="{{ asset('admin/assets/img/flags/italy_flag.jpg') }}"
                                        alt="img"></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar ml-3 align-self-center bg-transparent"><img
                                        src="{{ asset('admin/assets/img/flags/russia_flag.jpg') }}"
                                        alt="img"></span>
                                <div class="d-flex">
                            ...
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><img
                                        src="{{ asset('admin/assets/img/flags/spain_flag.jpg') }}"
                                        alt="img"></span>
                                <div class="d-flex">
                        ...
                        <div class="main-message-list chat-scroll">
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="  drop-img  cover-image  "
                                    data-image-src="{{ asset('admin/assets/img/faces/3.jpg') }}">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                    data-image-src="{{ asset('admin/assets/img/faces/2.jpg') }}">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                    data-image-src="{{ asset('admin/assets/img/faces/9.jpg') }}">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                    data-image-src="{{ asset('admin/assets/img/faces/12.jpg') }}">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                    data-image-src="{{ asset('admin/assets/img/faces/5.jpg') }}">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left">
                                    <a href="{{ route('MarkAsRead_all') }}">قراءة الكل</a>
                                </span>
                        ...
                        <div class="main-notification-list Notification-scroll">
                            @foreach (auth()->user()->unreadNotifications as $notification)
                                <a class="d-flex p-3 border-bottom" href="{{ route('order.showall', $notification->data['order_id']) }}">
                                    <div class="notifyimg bg-pink">
                                        <i class="la la-file-alt text-white"></i>
                                    </div>
                                    <div class="mr-3">
                                        <h5 class="notification-label mb-1">{{ $notification->data['message'] }}</h5>
                                        <div class="notification-subtext">{{ $notification->created_at->format('Y-m-d H:i') }}</div>
                                    </div>
                                </a>
                            @endforeach
                        </div>
...
<script>
document.querySelector('.badge-warning').addEventListener('click', function() {
    fetch('/notifications/mark-all-read', {
        ...
        if (response.ok) {
            ...
            alert('حدث خطأ عند تحديث الإشعارات');
        }
...
function deleteAllNotifications(event) {
    ...
    .then(data => {
        alert(data.message); // عرض رسالة تأكيد بعد مسح الإشعارات
        location.reload(); // تحديث الصفحة لإزالة الإشعارات من الواجهة
    })
    .catch(error => console.error('Error:', error));
}
...
<script>
    function sendNotification() {
        fetch('/send-notification', {
            ...
            body: JSON.stringify({ user_id: 1 }) // استخدم المعرف المناسب هنا
        })
        .then(response => response.json())
        .then(data => {
            if (data.message) {
            ...
            notificationArea.removeChild(notification);
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ asset('admin/assets/img/faces/6.jpg') }}"></a>
                    <div class="dropdown-menu">
                                ...
                                <div class="mr-3 my-auto">
                                    @if (Auth::check() && Auth::user()->usertype === 'admin')
                                        <div class="user-info">
                                            ...
                                            <h6 class="text-danger" style="font-size: 25px">
                                                {{ Auth::user()->usertype }}</h6>
                                        </div>
                                    @endif
