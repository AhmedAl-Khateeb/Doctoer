                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('show_order') }}">
                                      Your ORDER ({{ App\Models\Order::where('user_id', auth()->id())->count() }})
                                    </a>
                                </li>
                                </li>
                                <li>
                                    <div class="header-icons">
                                        ...
                                        @else
                                            ...
                                            <a class="dropdown-item btn btn-sm btn-danger" href="#"
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    <div class="list-box d-flex align-items-center">
                        ...
                        <div class="content">
                            <h3>بن محمص بعناية</h3>
                            <p>استمتع بمذاق أصيل وحبوب مختارة بعناية</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    <div class="list-box d-flex align-items-center">
                        ...
                        <div class="content">
                            <h3>مصدر مستدام</h3>
                            <p>نختار الحبوب من أفضل مزارع القهوة المستدامة</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="list-box d-flex justify-content-start align-items-center">
                        ...
                        <div class="content">
                            <h3>أصناف عالمية</h3>
                            <p>نوفرأصناف قهوة من جميع أنحاء العالم</p>
                        </div>
                    </div>
                </div>
            </div>
			...
			<div class="row">
				<div class="col-lg-11 mb-5 mb-lg-0">
					<div class="form-title">
						<h2 id="contact">Have you any question?</h2>
					</div>
